...
if ((screen.width > 1024)) {
	...
	document.getElementById("slideads").style.display = "none";
	document.getElementById("slideads1").style.display = "none";
	document.getElementById("slideads2").style.display = "none";  
}